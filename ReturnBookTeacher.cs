...
{
    public partial class ReturnBookTeacher : Form
    {
        ...
        private void ReturnBookTeacher_Load(object sender, EventArgs e)
        {
        ...
        public void fill_grid(string id)
        {
            ...
            cmd.CommandText = "select * from issue_book_teacher where teacher_id ='" + id.ToString() + "' and return_date ='' ";
            cmd.ExecuteNonQuery();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            SqlCommand cmd = sqlcon.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from issue_book_teacher where id = '" + i + "' ";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = sqlcon.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update issue_book_teacher set return_date = '" + dateTimePicker1.Value.ToString() + "' where id = '" + i + "' ";
            cmd.ExecuteNonQuery();
